...
public class PushCtrl extends Controller {
     ...
     * @param alert
     */
    public static void send_push_all(String alert){
     ...
     * @param extras 额外字段
     */
    public static void send_push_android_all(String alter,String title,Map<String, String> extras){
     ...
     * @param extras 额外字段
     */
    public static void send_push_ios_all(String alter,Map<String, String> extras){
        PushPayload pushPayload=PushPayload.newBuilder()
     ...
     * @param extras 额外字段
     */
    public static void send_push_android_tag(String alter,String title,Map<String, String> extras,String...tagValue){
        PushPayload pushPayload=PushPayload.newBuilder()
                .setPlatform(Platform.android())
     ...
     * @param extras 额外字段
     */
    public static void send_push_ios_tag(String alter,Map<String, String> extras,String...tagValue){
        PushPayload pushPayload=PushPayload.newBuilder()
                .setPlatform(Platform.ios())
                .setAudience(Audience.tag(tagValue))
                .setNotification(Notification.ios(alter,extras)).build();
     ...
     * @param extras 额外字段
     */
    public static void send_push_android_alias(String alter,String title,Map<String, String> extras,String...alias){
        PushPayload pushPayload=PushPayload.newBuilder()
                .setPlatform(Platform.android())
     ...
     * @param extras 额外字段
     */
    public static void send_push_ios_alias(String alter,Map<String, String> extras,String...alias){
        PushPayload pushPayload=PushPayload.newBuilder()
                .setPlatform(Platform.ios())
                .setAudience(Audience.alias(alias))
                .setNotification(Notification.ios(alter,extras)).build();
     ...
     */
    public static void send_push_android_registration_id(String alter,String title,Map<String, String> extras,String...registrationId){
        PushPayload pushPayload=PushPayload.newBuilder()
                .setPlatform(Platform.android())
     ...
     * @param registrationId
     */
    public static void send_push_ios_registration_id(String alter,Map<String, String> extras,String...registrationId){
        PushPayload pushPayload=PushPayload.newBuilder()
                .setPlatform(Platform.ios())
                .setAudience(Audience.registrationId(registrationId))
                .setNotification(Notification.ios(alter,extras)).build();
     ...
     * @return
     */
    public static PushPayload buildPushObject_all_alias_alert(String alter,String... alias) {
